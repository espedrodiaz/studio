        ...
        {userData?.status !== 'Active' && (
          <div className="space-y-2">
            <Label className="flex items-center gap-2 text-xs font-semibold text-muted-foreground">
                ...
                <span>Estado de la Licencia: {userData?.status}</span>
            </Label>
            <p className="text-xs text-muted-foreground">Activa tu licencia para desbloquear todas las funciones permanentemente.</p>
          </div>
        )}
