...
let registeredUsers: RegisteredUser[] = [
    ...
    { id: 'USER005', fullName: 'Pedro Díaz', businessName: 'Glenda Family', businessCategory: 'Venta de Repuestos', rif: 'V-25695305', licenseKey: 'F4C1-L1T0-P05V-ZL41', status: 'Pending Activation' },
];
